...
<div id="carousel-principal" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="img/CabezaDelBuey.jpg" alt="Construccion">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/Badajoz.jpg" alt="Casa">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/Extremadura.jpg" alt="Pintura">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/Hogar.jpg" alt="Servicio">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/Seguros.jpg" alt="Aseguradora">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/Construccion.jpg" alt="Seguro">
      <div class="carousel-caption">
      </div>
    </div>  
    <div class="item">
      <img src="img/Servicios.jpg" alt="Pueblo">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/Rehabilitacion.jpg" alt="Construcciones">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/ConstruccionObra.jpg" alt="Servicios">
      <div class="carousel-caption">
      </div>
    </div>
  </div>
